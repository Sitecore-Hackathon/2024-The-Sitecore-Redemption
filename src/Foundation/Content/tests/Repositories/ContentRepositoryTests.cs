...
using SitecoreRedemption.Foundation.Content.Repositories;
using SitecoreRedemption.Foundation.Content.Tests.Models;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using NSubstitute;
using Ploeh.AutoFixture;

namespace SitecoreRedemption.Foundation.Content.Tests.Repositories
{
    [TestClass]
